...
CFLAGS = -x c -funsigned-char -funsigned-bitfields -DDEBUG $(INCLUDES) -O2 -ffunction-sections -fdata-sections -fpack-struct -fshort-enums -mrelax -g2 -Wall -Wextra -mmcu=$(MCU) -c -std=gnu99
